...
public class InserNode_beforeANDAfter_GivenNode_GFG {
    ...
    public static void main(String[] args)
    {
        ...
        InserNode_beforeANDAfter_GivenNode_GFG dll = new InserNode_beforeANDAfter_GivenNode_GFG();
        ...
        System.out.println("Before Inserting Node at After:");
        ...
        System.out.println("Before Inserting Node at Before:");
        dll.InsertBefore(dll.head.next.next.next, 65);
        dll.printlist(dll.head);
    }
